# GameReference
I am working on a game, the following is a mix between a “game design document” and the description of a “minimum viable product”.
...
*   Card borders or backgrounds can subtly change based on card type (e.g., component, action, upgrade) but should remain within the overall technical aesthetic of the chosen theme.
    ...
    <figure class="image image-style-align-center image_resized" style="width:50%;"><img style="aspect-ratio:1024/1024;" src="GameReference_08fc461e-f18.png" width="1024" height="1024"><figcaption>Design Palette</figcaption></figure>

<figure class="image image-style-align-center image_resized" style="width:50%;"><img style="aspect-ratio:1024/1024;" src="GameReference_image.png" width="1024" height="1024"><figcaption>Gameplay Visual Reference</figcaption></figure>
